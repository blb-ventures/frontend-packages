...
module.exports = {
  ...
  settings: {
    ...
    // 'import/resolver': {
    //   node: { extensions: allExtensions.concat(['.json']) },
  ...
  rules: {
    ...
    // TODO: enable together with no-explicit-any
    ...
    // TODO: Enable and remove all any types
    '@typescript-eslint/no-explicit-any': 'off',

    // Custom rules
    'arrow-parens': ['warn', 'as-needed'],
    // TODO: Reduce to 20 or even 15.
    complexity: ['error', 50],
    'id-blacklist': [
      'error',
      'any',
    ...
    // FIXME: (not anymore) This option was set off to avoid having to disable this on every line of a test file that uses the Cypress (Chai) expect function to evaluate a library function response.
    ...
    // TODO: maybe reduce to 30?
    'import/max-dependencies': ['warn', { max: 60 }],
    ...
    'max-params': ['warn', 4],
    // TODO: reduce this to 20 or less
    'max-statements': ['warn', 36],
    'new-cap': [
      'error',
      {
        newIsCap: true,
    ...
    // TODO: enable and fix all sorting errors
    ...
    // TODO: enable and sort all props
